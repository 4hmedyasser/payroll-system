...
public class EngineerClass extends EmployeeClass{
    ...
    public String[][] viewEngineers(){
        String filepath="Engineers.txt";
        String[][] tempViewEng = null;
        try {
            String id =" ";
            String name=" ";
            String age=" ";
            ...
            while(w.hasNext())
            {
                ...
                tempViewList[1] = name;
                tempViewList[2] = age;
                tempViewList[3] = position;
                tempViewList[4] = workHours;
                tempViewList[5] = tax;
                tempViewList[6] = payRate;
                tempViewList[7] = salary;
                
                tempViewEng[i] = tempViewList;
                i++;
