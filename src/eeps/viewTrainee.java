    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String [] columns = {"ID" , "Name" , "Age" , "Position" , "Work Hours" , "Tax" , "Pay Rate" , "Salary"};
                
                JTable jTable1 = new JTable(tempTrain.viewTrainees() , columns);
                
                jTable1.getTableHeader().setFont(new Font("DejaVu Sans Condensed", Font.BOLD, 12));
                jTable1.getTableHeader().setBackground(new Color(32,178,170));
