...
public class upgradeTrainee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, 150, 20));
        ...
        getContentPane().add(upgrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 410, 120, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eeps/Images/upgrade (1) .png"))); // NOI18N
